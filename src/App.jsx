...
//     try {
//       const response = await fetch(
//         "https://boolean-api-server.fly.dev/pialoana/contact"
//       );
//       if (!response.ok) {
//         throw new Error("Failed to fetch contacts");
//       }
//       const data = await response.json();
//       // Convert contacts array to object for easier lookup
//       const contactsObj = data.reduce((obj, contact) => {
...
//             contactId: 6, // Assuming 42 is the correct contact ID
//           }),
//         }
//       );
//       if (!response.ok) {
...
//       const data = await response.json();
//       // Assuming you have a state variable named `comments` to store all comments for the post with postId 1
//       // You can update the comments state to include the new comment for the post with postId 1
...
//     if (!firstName || !lastName) return ""; // Return empty string if first name or last name is undefined
//     const initials =
...
//           </svg>
//           Cohort Manager
//           <div className="header-author-circle">
...
//           <li key={comment.id}>
//             <p>{comment.content}</p>
//             {/* Add any additional comment details you want to display */}
//           </li>
//         ))}
//       </ul>
//     </div>
        ...
        <section className="content">
          ...
          <div className="body">
            <Routes>
              ...
              <Route
                path="/post/:postId"
                element={<PostDetails contacts={contacts} />}
              />
            </Routes>
          </div>
        </section>
