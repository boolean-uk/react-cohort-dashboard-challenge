...
export default function SideBar () {
    ...
    let profilePageSelected = ""
    if (location.pathname === "/") {
        homePageSelected = "currentPage"
    }
    if (location.pathname === "/profile") {
        profilePageSelected = "currentPage"
    }

    return (
        <nav id="sideBar">
            <div onClick={handleHomeClick} id="homeContainer" className={homePageSelected}>
                <svg id="hIcon" width="33" height="36" viewBox="0 0 33 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M0.5 36V12L16.6 0L32.5 12V36H20.8V21.75H12.15V36H0.5Z" fill="#64648C" />
                </svg>
                <p>Home</p>
            </div>

            <div onClick={handleProfileClick} id="profileContainer" className={profilePageSelected}>
                <svg
                    width="41"
                    height="40"
                    viewBox="0 0 41 40"
